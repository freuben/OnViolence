OnViolenceMotor {var s, <out, basicPath, <>motor, sensor, <>lowVal, <>highVal, <>leftVal;
  var <>rightVal, bendLow, bendHigh, newMacroArray1, newMacroArray2, arrA, arrB, pivot1;
  var pivot2, step1, step2, thisArray1, thisArray2, <>direction1, <>direction2, oscNode;
  var sensorVal1, sensorVal2, <>sensorLag1, <>sensorLag2, whichPedal, noteLow, noteHigh;
  ...
  *new {arg outBus=0, vol=1, panMotor=0, lowVal=0, highVal=127, leftVal=0, rightVal=127,
  ...
  initOnViolenceMotor {arg outBus, vol, pan, valLow, valHigh, valLeft,valRight,pathName,
    ...
    basicPath = basicPath ?? { Document.standardizePath(thisPath); };
  ...
  pedalOn {arg num=0;
    ...
    if(direction1 == 0, {
      ...
      motor.put(0, \motor, 0,
        [\freq, (noteLow+bendLow).midicps.expexp(110, 1760, 55, 56320), \out, 0,
          \amp, volMotor, \pan, panMotor]);
    ...
    if(direction2 == 0, {
      ...
      motor.put(1, \motor, 0,
        [\freq, (noteHigh+bendHigh).midicps.expexp(110, 1760, 55, 56320), \out, 0,
          \amp, volMotor, \pan, panMotor]);
  ...
  bend1 {arg val;
    bendLow = val.linlin(0,127, -2.0,2);
    if(whichPedal == 1, {
      synth1.set(\freq, (noteLow+bendLow).midicps.expexp(110, 1760, 55, 56320));
    });
  }
  ...
  pedalLag {arg numPedal=1;
    ...
    //pedal lags
    lagArray = [[0.5, 0.8], [0.45714285714286, 0.71428571428571], [0.41428571428571,
      0.62857142857143], [0.37142857142857, 0.54285714285714], [0.32857142857143,
      0.45714285714286], [0.28571428571429, 0.37142857142857], [0.24285714285714,
      0.28571428571429], [0.2, 0.2]]/4;
  ...
  *initClass {
    ...
    StartUp.add {
      ...
      SynthDef(\motor, {arg freq=440, amp=0.2, out=0, gates=1, lag=0.1, globamp=1.0,
        pan=0;
        var signal;
      ...
      SynthDef(\lagging,{arg num=45, rate=500, low=20, high=60, id=0, lag=0.2;
        var values;
        values = Ramp.kr(num.linlin(low, high, 0, 127), lag);
